...
select_snp=(sys.argv[1]) #if total is not selected
selection_type=str(sys.argv[2]) #if not specified selects first k snp's, possilble selection modes: random, seeded, total, sequential, preselected
    ...
    with open(input) as file:
        ...
        for line in lines:
            if count==0:
                ...
                elif selection_type=="preselected":
                    selection.sort()
                    pass
