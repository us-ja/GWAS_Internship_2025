...
for seed in range(100, 101):
    ...
    print(sel_pers,"test")
    comm="25_s"+str(seed)
    res.append(combine_build_up(200, "HapMap",add_comm=comm, seed=seed, sel_pers=sel_pers,change_pers_func=givepers, checkdoubles=False,shuffle_in_level=True, total_snp=2000, deletelog=False, ))
