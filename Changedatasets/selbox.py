...
plt.title('Grouping Scheme: not in last level prediction accuracy')
# print(sh)
...
data=[sh, bound, alt_b,alt_s]#kfold_s,kfold_b ]
labels=["Shuffle 25\n"+str(len(sh)), "Ordered 25\n"+str(len(bound)), "Alternate Bound\n"+str(len(alt_b)),"Alternate Shuffle\n"+str(len(alt_s))]#"Pyramid shuffle \n"+str(len(kfold_s)),"Pyramid bound\n"+str(len(kfold_b))] 
