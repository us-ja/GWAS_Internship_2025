...
We have already seen that interfering with the data like for phenotype shuffling, provides further insights. In this chapter we try to evaluate what is possible to achieve with our method and what has to be expected simply by random occurrences. 
...
\begin{figure} [!ht] \centering{\includegraphics[ trim={0 0 0 10},clip, width=\linewidth]{accuracyplot.eps} 
